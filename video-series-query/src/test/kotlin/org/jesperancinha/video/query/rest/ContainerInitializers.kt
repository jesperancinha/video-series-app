...
class VideoSeriesQueryInitializer : ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    companion object {
        val logger: Logger = LoggerFactory.getLogger(VideoSeriesQueryInitializer::class.java)
